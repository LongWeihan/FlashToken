...
| --- | --- | --- | --- | --- |
| fixed_prefix (mixed, 2000 req) | 1580.24 ms | 57.53 ms | 27.47× | ~31× fewer encoded tokens |
| append_only (mixed, 400 turns) | 2203.70 ms | 58.51 ms | 37.66× | ~229× fewer encoded tokens; `rollback_max=78` |
...
- `assets/benchmark/standard_win10_py312/summary.md`
- `assets/benchmark/standard_win10_py312/results.json`
